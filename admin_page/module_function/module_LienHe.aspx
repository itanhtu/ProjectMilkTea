<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_LienHe.aspx.cs" Inherits="admin_page_module_function_module_LienHe" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="lienhe_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Email" FieldName="lienhe_email" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Điện thoại" FieldName="lienhe_phone" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Địa chỉ" FieldName="lienhe_address" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
