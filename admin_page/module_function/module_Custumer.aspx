<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_Custumer.aspx.cs" Inherits="admin_page_module_function_module_Custumer" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="customer_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Hình ảnh" FieldName="customer_image" Width="200px" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
                            <img src="<%#Eval("customer_image") %>" height="100" />
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Họ tên KH" FieldName="customer_name" HeaderStyle-HorizontalAlign="Center" Width="45%"></dx:GridViewDataColumn>
                    <%--   <dx:GridViewDataColumn Caption="Nội dung" FieldName="customer_content" HeaderStyle-HorizontalAlign="Center" Width="25%" Settings-AllowEllipsisInText="true"></dx:GridViewDataColumn>--%>

                    <dx:GridViewDataColumn Caption="Ngày phản hồi" FieldName="customer_date" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                </Columns>
                                ...
                                <div class="col-12">
                                    <div class="col-7">
                                        ...
                                        <div class="col-12 form-group">
                                            <label class="col-2 form-control-label">Họ tên KH:</label>
                                            <div class="col-10">
                                                <asp:TextBox ID="txtTenKH" runat="server" ClientIDMode="Static" CssClass="form-control" Width="94%"> </asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="text-color1"><i>Kích thước ảnh tiêu chuẩn 100x100</i></div>
