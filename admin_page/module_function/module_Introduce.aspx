        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="introduct_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tiêu Đề" FieldName="introduce_title1" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tóm tắt" FieldName="introduce_summary" HeaderStyle-HorizontalAlign="Center" Width="30%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                                    ...
                                    <div class="col-12">
                                        <div class="col-8">
                                            ...
                                            <div class="col-12 form-group">
                                                ...
                                                <div class="col-10">
                                                    <asp:TextBox ID="txtTitle1" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="90%"> </asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-12 form-group">
                                                <label class="col-2 form-control-label">Tóm lược:</label>
                                                <div class="col-10">
                                                    <textarea id="txtSummary" runat="server" rows="3" class="form-control" style="width:90%"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
