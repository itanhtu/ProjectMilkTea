        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" CssClass="table-hover" ClientInstanceName="grvList" KeyFieldName="news_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Ngày đăng tin" Settings-AllowEllipsisInText="true" FieldName="news_datetime" HeaderStyle-HorizontalAlign="Center" Width="15%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Trạng thái" Settings-AllowEllipsisInText="true" FieldName="active" HeaderStyle-HorizontalAlign="Center" Width="8%"></dx:GridViewDataColumn>
                </Columns>
