...
public partial class Admin_MasterPage : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var gettt = (from dke in db.tbDangKyEmails
                    where dke.dke_tinhtrang == "Xem"
                    orderby dke.dke_id descending
                    select dke).Count();
        countnew = gettt.ToString();
        var thongbao = (from tb in db.tbCustomers
                        where tb.cus_status == false
                        orderby tb.cus_id descending
                        select tb).Count();
        count = thongbao.ToString();
    ...
    protected void rpModule_Init(object sender, EventArgs e)
    {
        ...
        {
            admin_User logedMember = (admin_User)Session["Loged"];
    ...
    protected void btnChangePass_ServerClick(object sender, EventArgs e)
    {
